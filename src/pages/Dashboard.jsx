        ...
        <section ref={quickRef} className={`dash-card ${quickVisible ? 'anim-in' : ''}`} style={{ '--delay': '200ms' }}>
          ...
          <div className="dash-quick-grid">
            {[
              ...
              { to: '/coaching',         c: '#d81b60', label: 'Coaching perso',   sub: 'Mes coaches',       icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> },
